<%@ Page Title="" Language="C#" MasterPageFile="~/Administration.Master" AutoEventWireup="true" CodeBehind="frmReporteSalas.aspx.cs" Inherits="CinemaColaborativos.frmReporteSalas" %>
    ...
    <div class="contact-form">
        <div class="col-md-6 contact-left">
         ...
         <h3 class="head">Reporte de salas</h3>
                ...
                <br />
                Cantidad de sillas:
                         &nbsp;<asp:TextBox ID="txtCantidadSillas" runat="server" Height="100%" Width="100%"></asp:TextBox>
                <br />
                <br />Tipo de sala<br />
